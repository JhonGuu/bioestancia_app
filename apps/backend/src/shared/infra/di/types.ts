...
export const DI_TYPES = {
  ...
  TransporteValidation: Symbol.for("TransporteValidation"),
  TransportistaRepository: Symbol.for("TransportistaRepository"),
  ChoferRepository: Symbol.for("ChoferRepository"),
  VehiculoRepository: Symbol.for("VehiculoRepository"),
  TransporteClienteRepository: Symbol.for("TransporteClienteRepository"),
  CreateTransportista: Symbol.for("CreateTransportista"),
  ListTransportistas: Symbol.for("ListTransportistas"),
  GetTransportista: Symbol.for("GetTransportista"),
  UpdateTransportista: Symbol.for("UpdateTransportista"),
  DeleteTransportista: Symbol.for("DeleteTransportista"),
  ReactivarTransportista: Symbol.for("ReactivarTransportista"),
  CreateChofer: Symbol.for("CreateChofer"),
  ListChoferes: Symbol.for("ListChoferes"),
  GetChofer: Symbol.for("GetChofer"),
  UpdateChofer: Symbol.for("UpdateChofer"),
  DeleteChofer: Symbol.for("DeleteChofer"),
  ReactivarChofer: Symbol.for("ReactivarChofer"),
  CreateVehiculo: Symbol.for("CreateVehiculo"),
  ListVehiculos: Symbol.for("ListVehiculos"),
  GetVehiculo: Symbol.for("GetVehiculo"),
  UpdateVehiculo: Symbol.for("UpdateVehiculo"),
  DeleteVehiculo: Symbol.for("DeleteVehiculo"),
  ReactivarVehiculo: Symbol.for("ReactivarVehiculo"),
  GetTransporteCliente: Symbol.for("GetTransporteCliente"),
  SetTransporteCliente: Symbol.for("SetTransporteCliente"),
  TransporteController: Symbol.for("TransporteController"),
